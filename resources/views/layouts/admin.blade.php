    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="#" aria-expanded="false">
          ...
          <span class="badge badge-warning navbar-badge">Pengembalian Terlambat</span>
        </a>
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right" style="left: inherit; right: 0px;">
          <span class="dropdown-item dropdown-header"><b>{{ get_total_lewat() }} Daftar pengembalian terlambat</b></span>
          <div class="dropdown-divider"></div>
          @foreach (get_data_lewat() as $value )
          <a href="{{ url('peminjaman') }}" class="dropdown-item" style="font-size: 15px;">
            <i class="fas fa-exclamation-triangle mr-2 text-danger"></i> {{ $value['anggota']['nama'] }} 
            <span class="float-right text-muted text-sm">{{ $value['jumlah_lewat'] }} hari</span>
          </a>
@endforeach
          <div class="dropdown-divider"></div>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="image">
            <img src="{{ asset('dist/img/asd.jpg') }}" class="img-circle elevation-2" alt="User Image">
          </div>
          <div class="info">
